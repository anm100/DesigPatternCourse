...
public class addOtherInsuranceUI {
	...
	private OtherInsurance product ; 
	...
	public addOtherInsuranceUI(OtherInsurance product, InterfaceComposite parent ) {
	...
	private void initialize() {
		...
		addInsurance.setTitle("Add other insurance");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				product.setType(typeCom.getSelectedItem().toString());
				...
				dm2.addRow(new Object[] {product.getSid(),product.getNumberofpolicy(),product.getType(),product.getClientID(),product.getCompanyInsurance(),product.getStartDate(),product.getEndDate(),product.getPrice()});
		...
		typeCom.setBounds(105, 89, 200, 22);
		typeCom.addItem("Home");
		typeCom.addItem("Life");
		typeCom.addItem("Work disability");

		addInsurance.getContentPane().add(typeCom);
