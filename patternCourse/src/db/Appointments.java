...
public class Appointments extends View {
	...
	public Object getPatientAppointments(Request request) {
		...
		try {
			...
			MyConnection.getConfig().getLogger().exception(e);
			return null;
		}
	}
	...
	public Object delete(Request request) {
		...
		try {
			MyConnection.getConfig().getHandler().appointments.delete((Appointment) request.getParam("appointment"));
			return true;
	...
	public Object lastVisit(Request request, String doctor_id) {
		...
		try {
			...
			MyConnection.getConfig().getLogger().exception(e1);
		}
