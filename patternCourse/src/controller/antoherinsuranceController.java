...
import GUI.addOtherInsuranceUI;
...
public class antoherinsuranceController implements ActionListener {


	//ArrayList<Product> 
	private anotherInsurancePanel app;
	public antoherinsuranceController(anotherInsurancePanel app) {
		// TODO Auto-generated constructor stub
	this.app=app;
	getProductsToGUI(app);
	}
	public antoherinsuranceController(JFrame addProduct) {
		// TODO Auto-generated constructor stub
	}
	public void getProductsToGUI(anotherInsurancePanel app) {
		((anotherInsurancePanel) app).setdata((ArrayList<OtherInsurance>) OtherInsurance.getItems()); 
	}
	@Override
...
//		break;
		...
		addOtherInsuranceUI productGui = new  addOtherInsuranceUI(new OtherInsurance(),app);
